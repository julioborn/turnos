    ...
    return (
        <header className="fixed top-0 left-0 w-full bg-green-600 text-white shadow-md px-4 py-4 flex justify-between items-center z-50 h-20 sm:px-6">
            ...
            <button
                ...
                aria-label="Recargar"
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-7 mr-2">
                    ...
                    <>
                        ...
                        >
                            ...
                            <ul className="flex flex-col gap-2">
                                {esAdmin && (
                                    <>
                                        ...
                                        {session?.user.rol === "superusuario" && (
                                            <li>
                                                <button
                                                    onClick={() => handleNavigate("/admin/balance")}
                                                    className="flex gap-1 w-full bg-white text-left px-4 py-3 rounded-lg shadow hover:bg-green-100 transition font-semibold text-gray-800"
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
                                ...
                                {["cliente", "admin", "superusuario"].includes(session?.user.rol || "") && (
                                    <li>
                                        <button onClick={() => handleNavigate("/perfil")} className="flex gap-1 w-full bg-white text-left px-4 py-3 rounded-lg shadow hover:bg-green-100 transition font-semibold text-gray-800">
                                            {/* Ícono Perfil */}
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
