...
export default function ReservasFutbol() {
  ...
  const deporteId = actividadIds["futbol"];
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      <div className="w-full max-w-md mt-10">
        <div className="flex flex-col items-center mb-6">
          <h1 className="text-3xl uppercase font-black text-green-700 tracking-tight">Fútbol</h1>
