...
export default function ReservasBasquet() {
  ...
  const deporteId = actividadIds["basquet"];
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      <div className="w-full max-w-md mt-10">
        <div className="flex flex-col items-center mb-6">
          <h1 className="text-4xl uppercase font-black text-green-700 tracking-tight">Básquet</h1>
              ...
              <tbody>
                {horariosPlantilla.map((h) => {
                  ...
                  const reservasEnEseHorario = reservasDelDia.filter(
                    (r) => obtenerIdReserva(r) === idPlantilla && r.cancha === 1
                  );
                  const reservaDelUsuario = reservasEnEseHorario.find(
                    (r) => r.correoCliente === session?.user.documento && r.estado !== "rechazada"
                  );
                  const hayReservaAprobada = reservasEnEseHorario.some((r) => r.estado === "aprobada");
                  ...
                  return (
                    <tr key={idPlantilla} className="text-center">
                      ...
                      <td className="border px-2 py-2">
                        <button
                          onClick={() => reservarHorario(idPlantilla, 1, h.horaInicio, h.horaFin)}
                          disabled={disabled}
